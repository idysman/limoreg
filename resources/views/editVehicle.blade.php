                ...
                <div class="statbox widget box box-shadow">
                    ...
                    <div class="widget-content widget-content-area">
                           ...
                           <div class="form-row">
                                <div class="col-sm-4">
                                    <div class="form-group mb-4">
                                        ...
                                        <input type="text" name="engine_number" class="form-control @error('engine_number') is-invalid @enderror"  value="{{ $vehicle->engine_number }}" id="engine-number" placeholder="Engine's Number*" required>
                            ...
                            <div class="col-sm-4">
                                <div class="form-group mb-4">
                                    ...
                                    <input type="text"  value="{{ $vehicle->chassis_number }}" name="chassis_number" class="form-control  @error('chassis_number') is-invalid @enderror" id="rsurname" placeholder="Chassis Number*" required>
                        ...
                        <div class="col-sm-4">
                            <div class="form-group mb-4">
                                ...
                                <input type="text"  value="{{ $vehicle->plate_number }}" name="plate_number" class="form-control @error('plate_number') is-invalid @enderror" id="plateNumber" placeholder="Plate Number" required>
                        ...
                        <div class="form-row">
                            <div class="col-sm-4">
                                <div class="form-group mb-4">
                                    ...
                                    <input type="text" name="model" class="form-control @error('model') is-invalid @enderror"  value="{{ $vehicle->model }}"  id="car-model" placeholder="Automobile Model*" required>
                    ...
                    <div class="form-row">
                        <div class="col-sm-4">
                            <div class="form-group mb-4">
                                ...
                                <input type="text"  value="{{ $vehicle->policy_number }}" name="policy_number" class="form-control @error('policy_number') is-invalid @enderror" id="policy-number" placeholder="Policy Number" required>
                        ...
                        <div class="col-sm-4">
                            <div class="form-group mb-4">
                                ...
                                <input type="text"  value="{{ $vehicle->engine_capacity }}" name="engine_capacity" class="form-control @error('engine_capacity') is-invalid @enderror" id="engine-capacity" placeholder="Engine Capacity" required>
                    ...
                    <div class="form-row">
                        <div class="col-sm-4">
                            <div class="form-group mb-4">
                                ...
                                <input type="text"  value="{{ $vehicle->color }}" name="color" class="form-control @error('color') is-invalid @enderror" id="color" placeholder="Vehicle color" required>
                        ...
                        <div class="col-sm-4">
                            <div class="form-group mb-4">
                                ...
                                <input type="text"  value="{{ $vehicle->fuel_type }}" name="fuel_type" class="form-control @error('fuel_type') is-invalid @enderror" id="fuel-type" placeholder="Fuel Type" required>
                        ...
                        <div class="col-sm-4">
                            <div class="form-group mb-4">
                                ...
                                <input type="text"  value="{{ $vehicle->odometer }}" name="odometer" class="form-control @error('odometer') is-invalid @enderror" id="odometer" placeholder="Odometer" required>
                    ...
                    <div class="form-row">
                        <div class="col-sm-4">
                            <div class="form-group mb-4">
                                ...
                                <input type="text"  value="{{ $vehicle->title }}" name="title" class="form-control @error('title') is-invalid @enderror" id="title" placeholder="Name of the car" required>
                        ...
                        <div class="col-sm-4">
                            <div class="form-group mb-4">
                                ...
                                <input type="number" value="{{ $vehicle->year_of_manufacture }}" name="year_of_manufacture" class="form-control @error('year_of_manufacture') is-invalid @enderror" id="year-of-manufacture" placeholder="Year of Manufacture" required>
                        ...
                        <div class="col-sm-4">
                            <div class="form-group mb-4">
                                ...
                                <input type="text"  value="{{ $vehicle->address }}" name="address" class="form-control @error('address') is-invalid @enderror" id="title" placeholder="Address of owner" required>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-row m-auto">
                            <button type="submit" class="btn btn-primary my-4 w-50 py-3 ">Submit</button>
                        </div>
                        </form>
                    </div>
                </div>
