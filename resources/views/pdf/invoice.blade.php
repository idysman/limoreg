    ...
    <style>
        ...
        *{
        ...
        body{
            width: 100%;
            height: 100%;
            background-image: "{{ asset('assets/img/imoirslogo.png') }}";
          ...
          <div class="col-container">
            ...
            <div class="col-container mb-3">
                ...
                <div class="col">
                    ...
                    <p class="mb-2"><span class="info-head">Owner's Name</span>: Jenkins Jemmy</p>
                    <p class="mb-2"><span class="info-head">Owner's Email</span>: derotem@gmail.com</p>
                    <p class="mb-2"><span class="info-head">Phone Number</span>: 0809765647</p>
                    <p class="mb-2"><span class="info-head">Engine Number</span>: 1334564647hfu</p>
                    <p class="mb-2"><span class="info-head">License Number</span>: 565756YTIU678</p>
                    <p class="mb-2"><span class="info-head">Chassis Number</span>: 565756YTIU678</p>
                </div>
                ...
                <div style="background:white" class="col text">
                    ...
                    <p class="mb-2"><span class="info-head">Invoice No</span>: 234356758574</p>
                    <p class="mb-2"><span class="info-head">Created At</span>: 23, July 2021</p>
                    <p class="mb-2"><span class="info-head">Transaction Ref. </span>: MNTA456RTRY689</p>
                    <p class="mb-2"><span class="info-head">Status</span>: Unpaid</p>
                    <p class="mb-2"><span class="info-head">Service</span>: Vehicle License</p>
                </div>
            </div>
                ...
                <div class="col">
                    <table>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>9</td>
                                <td>Classis Networl</td>
                                <td>500</td>
                            </tr>
                            <tr class="total">
                                <td colspan="2">Sub-total</td>
                                <td> <del style="text-decoration-style: double;">N</del> 30000</td>
                            </tr>
                            <tr class="total">
