    ...
    <div class="invoice">
        ...
        <div class="col-container" style="margin-bottom:2px;">
            <div class="col" >
              ...
              <h3 style="color:rgb(99, 6, 6); text-align: center;">IMO STATE VEHICLE LICENSING AUTHORITY</h3>
        ...
        <div  style="display:block; width:65%;padding:20px;margin:0 auto;">
            <div style="padding: 50px; width: auto;">
                <p>
                    <span style="text-align: left;">NUMBER PLATE ISSUANCE RECIEPT</span>
                    <span style="text-align: right;">BASG/IRS/RW &nbsp;
                         <span>002159</span>
                    </span>
                </p>
            </div>
