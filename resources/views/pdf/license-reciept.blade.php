  ...
  <body>
    ...
    <div class="invoice">
        <div style="padding: 10px;">
            <p style="float: right; text-size-adjust: 10px;">http://ivreg.com.ng/license/reciept</p>
        </div>
        ...
        <div class="col-container" style="margin-bottom:2px;">
            <div class="col" >
              ...
              <h3 style="color:rgb(99, 6, 6); text-align: center;">INTERNAL REVENUE SERVICE</h3>
        ...
        <div  style="display:block; width:65%;padding:20px;margin:0 auto;">
            {{-- <div style="padding: 50px; width: auto;"> --}}
                ...
                <p style="text-align:right; ">002159</p>
            {{-- </div> --}}
            {{-- <div></div> --}}
            {{-- <div style="padding: 50px; width: auto;"> --}}
                {{-- <p><span style="float: left;">ROAD WORTHINESS RECIEPT</span> <span style="float: right;">BASG/IRS/RW</span></p> --}}
                <p><span style="text-align: left;">ROAD WORTHINESS RECIEPT</span> <span style="float: right;">BASG/IRS/RW</span></p>
            {{-- </div> --}}

            <div style="border: 1px solid black;margin:0 auto; border-radius: 10px;">
                {{-- <div style="float: left;"> --}}
                    <h4 style="writing-mode: vertical-rl; margin-top: 50px; float:left margin-left: 20px;">ROAD WORTHINESS</h4>
                {{-- </div> --}}
