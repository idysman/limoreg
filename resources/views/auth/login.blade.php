                        ...
                        <form class="text-left" method="POST"  action="{{ route('login') }}">
                            ...
                            <div class="form">
                                ...
                                <div id="username-field" class="field-wrapper input">
                                    ...
                                    <input id="username" name="username" value="{{ old('username') }}" type="text" class="form-control  @error('username') is-invalid @enderror" placeholder="Your email or phone Number" required autocomplete="username" autofocus>
                                    @error('username')
                                ...
                                <div id="password-field" class="field-wrapper input mb-2">
                                    ...
                                    <input id="password" name="password" required autocomplete="current-password" type="password" class="form-control  @error('password') is-invalid @enderror" placeholder="Your Password">
