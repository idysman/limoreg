                    ...
                    <div class="widget-content widget-content-area br-6">
                        <div class="table-responsive mb-4 mt-4">
                            <h5 class="mb-3" style="border-bottom:1px solid rgb(226, 223, 223)">Filters</h5>
                                <form class="form-inline" method="get" action="{{ route('reciepts.all') }}">
                        ...
                        <div class="table-responsive mb-4 mt-4">
                            <table id="html5-extension" class="table table-hover non-hover" style="width:100%">
                                ...
                                <tbody>
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuReference1">
                                                        {{-- <a class="dropdown-item" href="{{ route('reciepts.show',$reciept->id) }}">View</a> --}}

                                                        <a class="dropdown-item" href="{{ route('reciepts.download',$reciept->id) }}">Download</a>
                                    ...
                                    @empty
                                    <tr>
                                        <td class="text-center" colspan="7"><span class="text-danger text-center">No Reciept found</span>
                                        </td>
                                    </tr>
                                    @endforelse
                                </tbody>
